...
import RenderMembershipBatchFlowFields from './RenderMembershipBatchFlowFields';
import fieldTypes from 'payload/dist/admin/components/forms/field-types';
import Form from '../Form/Form';
import './batch.scss';
import '../../global.scss';
import MembershipBatchSent from './MembershipBatchSent';
import { CREDENTIAL_BATCH_STATUS } from '../../constants/batches';

const baseClass = 'collection-edit';

const CreateMembershipBatch: React.FC<Props> = props => {
    ...
    const sendOutBatchEmails = async (formData?: { emailTemplate: string }) => {
        const res = await fetch('/api/send-batch-email', {
            ...
            body: JSON.stringify({
                batchId: id,
                emailTemplateId: formData?.emailTemplate,
        ...
        <OperationContext.Provider value={operation}>
            ...
            >
                <section className="h-full w-full flex">
                    {!isLoading && (
                        <>
                            <RenderMembershipBatchFlowFields
                                readOnly={isReadOnly}
                            ...
                            />
                            <MembershipBatchSent slug={batchSlug} />
                        </>
                    )}
                </section>
            </Form>
...
export default CreateMembershipBatch;
