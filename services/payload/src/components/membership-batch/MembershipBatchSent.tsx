...
export type MembershipBatchSentProps = {
    slug: string;
};

const MembershipBatchSent: React.FC<MembershipBatchSentProps> = ({ slug }) => {
        ...
        <Drawer header={false} slug={slug} gutter={false}>
            <section className="relative w-full h-full flex items-center justify-center">
                <button
                    ...
                    onClick={() => {
                        closeModal(slug);
                        history.push('/admin/collections/membership-batch');
                    }}
                />
                ...
                <section className="relative bg-[--theme-bg] rounded-2xl p-10 flex flex-col gap-5 items-center w-full max-w-xl">
                    ...
                    <p className="text-center font-inter text-xl font-normal">
                        ...
                        to earners for them to claim their memberships. Please note that no further
...
export default MembershipBatchSent;
