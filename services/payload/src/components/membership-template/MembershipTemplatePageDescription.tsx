...
const MembershipTemplatePageDescription: React.FC = () => {
    const {
    ...
    const fetchBatchCredentials = async (page = 1) => {
        const res = await fetch('/api/get-collection-count', {
            method: 'POST',
            body: JSON.stringify({
                collectionName: 'membership-template',
    ...
    return (
        <div className="header_wrapper">
            ...
            <Link
                ...
                to={`${adminRoute}/collections/membership-template/create`}
            >
...
export default MembershipTemplatePageDescription;
